...
namespace pcpp {
  ...
  public:
    ...
    /*
     * A constructor for this class. This constructor doesn't create the raw socket, but rather initializes internal structures. The actual
    ...
    /**
     * Open the device by creating a raw socket and binding it to the network interface specified in the constructor
