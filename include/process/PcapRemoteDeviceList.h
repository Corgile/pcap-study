...
namespace pcpp {
  ...
  private:
    ...
    // private constructor. User should create the list via static methods PcapRemoteDeviceList::getRemoteDeviceList()
  ...
  public:
    ...
    getRemoteDeviceList(const IPAddress &ipAddress, uint16_t port, PcapRemoteAuthentication *remoteAuth);
