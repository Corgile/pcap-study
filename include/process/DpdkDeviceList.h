...
namespace pcpp {
   ...
   * one active instance doesn't have a public constructor. This class has several main uses:
  ...
  public:
     ...
     */
    static bool
    initDpdk(CoreMask coreMask, uint32_t mBufPoolSizePerDevice, uint8_t masterCore = 0, uint32_t initDpdkArgc = 0,
             char **initDpdkArgv = NULL, const std::string &appName = "pcapplusplusapp");
