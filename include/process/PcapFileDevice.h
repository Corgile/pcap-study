...
namespace pcpp {
  ...
  /**
   * @class IFileDevice
   * An abstract class (cannot be instantiated, has a private constructor) which is the parent class for all file devices
   */
   ...
   * An abstract class (cannot be instantiated, has a private constructor) which is the parent class for file reader devices
   */
  ...
  public:
     ...
     * @param[in] fileName The full path of the file to read
     */
    PcapFileReaderDevice(const std::string &fileName) : IFileReaderDevice(fileName),
...
#pragma pack()
  ...
  public:
     ...
     * @param[in] fileName The full path of the file to read
     */
    SnoopFileReaderDevice(const std::string &fileName) : IFileReaderDevice(fileName),
                                                         m_PcapLinkLayerType(LINKTYPE_ETHERNET) {}
  ...
  public:
    ...
    /**
     * The pcap-ng format allows storing metadata at the common of the file. Part of this metadata is a string specifying the
    ...
    /**
     * The pcap-ng format allows storing metadata at the common of the file. Part of this metadata is a string containing a user-defined
   ...
   * An abstract class (cannot be instantiated, has a private constructor) which is the parent class for file writer devices
   */
  ...
  public:
     ...
     * if file wasn't found or couldn't be read, if file type is not pcap, or if link type specified in constructor is
   ...
   * unique capabilities such as writing metadata attributes into the file common, adding comments per packet and opening
  ...
  public:
     ...
     * metadata attributes that will be stored in the common of the file
