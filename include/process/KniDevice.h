...
namespace pcpp {
  ...
  public:
     ...
     * rte_kni.h common file of DPDK to track the difference in signatures
     */
  ...
  public:
     ...
     */
    int
    startCaptureBlockingMode(OnKniPacketArriveCallback onPacketArrives, void *onPacketArrivesUserCookie, int timeout);
