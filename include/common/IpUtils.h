 ...
 * @param[in] common Network address structure, can be either in_addr (IPv4) or in6_addr (IPv6)
 ...
 * @param[in] af Address family, can be either AF_INET (IPv4) or AF_INET6 (IPv6)
 * @param[in] common Network address string representation
