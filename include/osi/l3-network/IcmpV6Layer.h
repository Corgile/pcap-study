...
namespace pcpp {
  ...
  /**
   * @struct icmpv6hdr
   * Represents an ICMPv6 protocol common
   */
#pragma pack(push, 1)
  struct icmpv6hdr {
...
#pragma pack(pop)
   ...
   */
  class IcmpV6Layer : public AbstractLayer {
  public:
    /**
     ...
     */
    IcmpV6Layer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet)
        : AbstractLayer(data, dataLen, prevLayer, packet) { m_Protocol = ICMPv6; }
     ...
     * @return AbstractLayer* A newly allocated ICMPv6 layer
     */
    static AbstractLayer *parseIcmpV6Layer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet);
    ...
    /**
     * @return Get the code common field
     */
    uint8_t getCode() const;

    /**
     * @return Get the checksum common field in host representation
     */
  ...
  public:
     ...
     */
    ICMPv6EchoLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet)
