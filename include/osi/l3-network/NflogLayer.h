...
namespace pcpp {
  /**
   * @struct nflog_header
   * Represents Nflog common
   */
#pragma pack(push, 1)
  struct nflog_header {
    /** A Linux AF_ value, so it's 2 for IPv4 and 10 for IPv6 */
    uint8_t addressFamily;
    /** The version field is 0 for the current version of the pseudo-common */
    uint8_t version;
...
#pragma pack(pop)
  ...
  */
  enum class NflogTlvType {
    ...
    NFULA_HWTYPE = 15,
    /** skbuff's MAC-layer common */
    NFULA_HWHEADER = 16,
    /** length of skbuff's MAC-layer common */
    NFULA_HWLEN = 17,
  };
   ...
   */
  class NflogLayer : public AbstractLayer {
  public:
    /**
    ...
    */
    ...
    /**
     * Get Version number inside packet common
     * The version field is 0 for the current version of the pseudo-common
    ...
    */
    ...
    /**
     * Get Resource Id in packet common
