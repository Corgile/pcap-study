...
namespace pcpp {
   ...
   */
  class MplsLayer : public AbstractLayer {
  private:
...
#pragma pack(pop)
  ...
  public:
    ...
    */
    MplsLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : AbstractLayer(data, dataLen, prevLayer,
                                                                                                       packet) { m_Protocol = MPLS; }

    /**
     * A constructor that allocates a new MPLS common
