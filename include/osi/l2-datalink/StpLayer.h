...
#pragma pack(pop)
  ...
  /// Spanning Tree protocol common common
...
#pragma pack(pop)
  ...
  /**
   * @class StpLayer
   * Represents an Spanning Tree Protocol AbstractLayer
   */
  class StpLayer : public AbstractLayer {
  protected:
    StpLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet)
  ...
  public:
    ...
    /**
     * Get a pointer to base Spanning tree common
     * @return A pointer to spanning tree common
     */
     ...
     */
    static StpLayer *parseStpLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet);
  };
  ...
  public:
     ...
     */
    StpTopologyChangeBPDULayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet)
        : StpLayer(data, dataLen, prevLayer, packet) {
    }

    /**
     * Empty constructor to create a new network topology change (TCN) BPDU layer.
  ...
  public:
     ...
     * @param[in] packet A pointer to the Packet instance where layer will be stored in
     */
    StpConfigurationBPDULayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet)
        : StpTopologyChangeBPDULayer(data, dataLen, prevLayer, packet) {
    }

    /**
     * Empty constructor to create a new configuration BPDU layer.
     * Initializes the protocol identifier, version and STP type fields with correct values
     */
  ...
  public:
     ...
     * @param[in] packet A pointer to the Packet instance where layer will be stored in
     */
    RapidStpLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet)
        : StpConfigurationBPDULayer(data, dataLen, prevLayer, packet) {
    }

    /**
     * Empty constructor to create a new Rapid STP layer.
     * Initializes the protocol identifier, version and STP type fields with correct values
     */
    RapidStpLayer();

    /**
     * Get a pointer to Rapid STP common
     * @return A pointer to Rapid STP common
     */
  ...
  public:
     ...
     * @param[in] packet A pointer to the Packet instance where layer will be stored in
     */
    MultipleStpLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet)
        : RapidStpLayer(data, dataLen, prevLayer, packet) {
    }

    /**
     * Empty constructor to create a new Multiple STP layer.
     * Initializes the protocol identifier, version and STP type fields with correct values
     */
    MultipleStpLayer();

    /**
     * Get a pointer to Multiple STP common
     * @return A pointer to Multiple STP common
     */
