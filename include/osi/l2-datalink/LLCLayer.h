...
namespace pcpp {
  /**
   * @struct llc_header
   * Logical Link Control (LLC) common
   */
#pragma pack(push, 1)
  struct llc_header {
...
#pragma pack(pop)
   ...
   */
  class LLCLayer : public AbstractLayer {
  public:
     ...
     */
    LLCLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : AbstractLayer(data, dataLen, prevLayer,
                                                                                                      packet) { m_Protocol = LLC; }
    ...
    /**
     * Get a pointer to Logical Link Control (LLC) layer common
     * @return Pointer to LLC common
     */
    ...
    /**
     * @return Get the size of the LLC common
     */
    ...
    /**
     * @return The OSI layer level of LLC (Data Link AbstractLayer).
     */
