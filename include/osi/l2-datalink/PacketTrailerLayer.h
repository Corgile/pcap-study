...
namespace pcpp {
   ...
   *
   * Although this layer inherits from the AbstractLayer class, it is not a standard layer in the sense that it can't be constructed by the user.
   ...
   */
  class PacketTrailerLayer : public AbstractLayer {
  public:
    ...
    */
    PacketTrailerLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : AbstractLayer(data, dataLen,
                                                                                                                prevLayer,
                                                                                                                packet) { m_Protocol = PacketTrailer; }
