...
#include "osi/l7-application/SomeIpLayer.h"
#include <cstring>
#include <iterator>
#include <map>
#include <memory>
...
namespace pcpp {
  ...
  public:
     ...
     * Represents the common base for SOME/IP-SD common options
     */
#pragma pack(push, 1)
    struct someipsdhdroptionsbase {
...
#pragma pack(pop)
    ...
    /**
     * Get a pointer to the SOME/IP-SD Option base common
   ...
   * Implements the following SOME/IP-SD Options: IPv4 Endpoint, sf_IPv4 Multicast, sf_IPv4 SD Endpoint
   */
  ...
  public:
     ...
     */
    enum IPv4OptionType {
      /** sf_IPv4 Endpoint Option */
      IPv4Endpoint,
      /** sf_IPv4 Multicast Option */
      IPv4Multicast,
      /** sf_IPv4 SD Endpoint Option */
      IPv4SdEndpoint,
    };

    /**
     * Construct a new SomeIpSdIPv4 Option object
     * @param[in] type sf_IPv4 Option type
  ...
  private:
     ...
     * Represents the sf_IPv4 option types for the SOME/IP-SD common
     */
#pragma pack(push, 1)
    struct someipsdhdroptionsipv4 : someipsdhdroptionsbase {
      /* sf_IPv4-Address field */
      uint32_t ipv4Address;
      /* Reserved */
      // cppcheck-suppress duplInheritedMember
      uint8_t reserved;
      /* AbstractLayer 4 Protocol field (L4-Proto) - Either UDP or TCP */
...
#pragma pack(pop)
  ...
  private:
     ...
     * Represents the IPv6 option types for the SOME/IP-SD common
     */
#pragma pack(push, 1)
...
#pragma pack(pop)
  ...
  private:
     ...
     * Represents the Load Balancing option common for SOME/IP-SD
     */
#pragma pack(push, 1)
...
#pragma pack(pop)
     ...
     * @param[in] pSomeIpSdLayer AbstractLayer that this entry is created for
    ...
    /**
     * Get a pointer to the SOME/IP-SD Entry common
  ...
  public:
     ...
     */
    SomeIpSdLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet);
     ...
     * @param[in] flags Flags that shall be used in the common
     */
  ...
  private:
    /**
     * @struct someipsdhdr
     * Represents an SOME/IP-SD protocol common
     */
#pragma pack(push, 1)
