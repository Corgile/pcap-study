...
namespace pcpp {
  ...
  protected:
    FtpLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : SingleCommandTextProtocol(data, dataLen,
                                                                                                                  prevLayer,
                                                                                                                  packet) { m_Protocol = FTP; };

    FtpLayer(const std::string &command, const std::string &option) : SingleCommandTextProtocol(command,
                                                                                                option) { m_Protocol = FTP; };
  ...
  public:
    ...
    /**
     * @return The OSI layer level of FTP (Application AbstractLayer).
     */
  ...
  /**
   * Class for representing the request messages of FTP AbstractLayer
   */
  ...
  public:
     ...
     */
    FtpRequestLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : FtpLayer(data, dataLen,
                                                                                                        prevLayer, packet) {};
     ...
     */
    explicit FtpRequestLayer(const FtpCommand &command, const std::string &option = "") : FtpLayer(
        getCommandAsString(command), option) {};
  ...
  /**
   * Class for representing the response messages of FTP AbstractLayer
   */
  ...
  public:
     ...
     * @param[in] packet A pointer to the Packet instance where layer will be stored in
     */
    FtpResponseLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : FtpLayer(data, dataLen,
                                                                                                         prevLayer, packet) {};
     ...
     */
    explicit FtpResponseLayer(const FtpStatusCode &code, const std::string &option = "") : FtpLayer(
        std::to_string(int(code)), option) {};
  ...
  /**
   * Class for representing the data of FTP AbstractLayer
   */
  ...
  public:
     ...
     * @param[in] packet A pointer to the Packet instance where layer will be stored in
     */
    FtpDataLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : PayloadLayer(data, dataLen,
                                                                                                         prevLayer,
                                                                                                         packet) { m_Protocol = FTP; };
