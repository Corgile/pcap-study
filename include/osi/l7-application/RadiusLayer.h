...
namespace pcpp {
   ...
   * Represents a RADIUS protocol common
   */
#pragma pack(push, 1)
  struct radius_header {
    /** RADIUS message code */
...
#pragma pack(pop)
  ...
  public:
    ...
    /**
     * A constructor for this class that gets a pointer to the attribute raw data (byte array)
   ...
   * A class for building RADIUS attributes. This builder receives the attribute parameters in its constructor,
  ...
  public:
    ...
    /**
     * A constructor for building RADIUS attributes which their value is a byte array. The RadiusAttribute object can later
    ...
    /**
     * A constructor for building RADIUS attributes which have a 1-byte value. The RadiusAttribute object can later be retrieved
     * by calling build()
     * @param[in] attrType RADIUS attribute type
    ...
    /**
     * A constructor for building RADIUS attributes which have a 2-byte value. The RadiusAttribute object can later be retrieved
     * by calling build()
     * @param[in] attrType RADIUS attribute type
    ...
    /**
     * A constructor for building RADIUS attributes which have a 4-byte value. The RadiusAttribute object can later be retrieved
     * by calling build()
     * @param[in] attrType RADIUS attribute type
    ...
    /**
     * A constructor for building RADIUS attributes which have an IPv4Address value. The RadiusAttribute object can later be
    ...
    /**
     * A constructor for building RADIUS attributes which have a string value. The RadiusAttribute object can later be retrieved
     * by calling build()
     * @param[in] attrType RADIUS attribute type
    ...
    /**
     * A copy constructor which copies all the data from another instance of RadiusAttributeBuilder
    ...
    /**
     * Build the RadiusAttribute object out of the parameters defined in the constructor
   ...
   */
  class RadiusLayer : public AbstractLayer {
  private:
  ...
  public:
     ...
     */
    RadiusLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) :
        AbstractLayer(data, dataLen, prevLayer, packet) { m_Protocol = Radius; }
     ...
     * @param[in] udpData The pointer to the UDP payload data. It points to the first byte of RADIUS common.
