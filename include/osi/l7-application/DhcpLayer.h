...
namespace pcpp {
  ...
  /**
   * @struct dhcp_header
   * Represents a DHCP protocol common
   */
#pragma pack(push, 1)
  struct dhcp_header {
    /** BootP opcode */
...
#pragma pack(pop)
  ...
  public:
     ...
     * @return DHCP option data as sf_IPv4 address
     */
    ...
    /**
     * Set DHCP option data as sf_IPv4 address. This method copies the 4 bytes of the IP address to the option value
   ...
   * A class for building DHCP options. This builder receives the option parameters in its constructor,
  ...
  public:
    ...
    /**
     * A constructor for building DHCP options which their value is a byte array. The DhcpOption object can later
    ...
    /**
     * A constructor for building DHCP options which have a 1-byte value. The DhcpOption object can later be retrieved
     * by calling build()
     * @param[in] optionType DHCP option type
    ...
    /**
     * A constructor for building DHCP options which have a 2-byte value. The DhcpOption object can later be retrieved
     * by calling build()
     * @param[in] optionType DHCP option type
    ...
    /**
     * A constructor for building DHCP options which have a 4-byte value. The DhcpOption object can later be retrieved
     * by calling build()
     * @param[in] optionType DHCP option type
    ...
    /**
     * A constructor for building DHCP options which have an IPv4Address value. The DhcpOption object can later be
     * retrieved by calling build()
     * @param[in] optionType DHCP option type
     * @param[in] optionValue The sf_IPv4 address option value
     */
    DhcpOptionBuilder(DhcpOptionTypes optionType, const IPv4Address &optionValue) :
        TLVRecordBuilder((uint8_t) optionType, optionValue) {}

    /**
     * A constructor for building DHCP options which have a string value. The DhcpOption object can later be retrieved
     * by calling build()
     * @param[in] optionType DHCP option type
    ...
    /**
     * A copy constructor which copies all the data from another instance of DhcpOptionBuilder
    ...
    /**
     * Build the DhcpOption object out of the parameters defined in the constructor
   ...
   */
  class DhcpLayer : public AbstractLayer {
  public:
     ...
     */
    DhcpLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet);
    ...
    /**
     * @return The client sf_IPv4 address (as extracted from dhcp_header#clientIpAddress converted to IPv4Address object)
     */
