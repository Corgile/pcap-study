...
namespace pcpp {
   ...
   */
  class SingleCommandTextProtocol : public AbstractLayer {
  private:
  ...
  protected:
    SingleCommandTextProtocol(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : AbstractLayer(data, dataLen,
                                                                                                                       prevLayer,
                                                                                                                       packet) {};
