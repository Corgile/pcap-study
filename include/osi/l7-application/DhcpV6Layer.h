...
namespace pcpp {
   ...
   * A class for building DHCPv6 options. This builder receives the option parameters in its constructor,
  ...
  public:
    /**
     * A constructor for building DHCPv6 options from a string representing the hex stream of the raw byte value.
    ...
    /**
     * A constructor for building DHCPv6 options from a byte array representing their value. The DhcpV6Option object can be later
    ...
    /**
     * Build the DhcpV6Option object out of the parameters defined in the constructor
   ...
   * Represents the basic DHCPv6 protocol common
   */
  struct dhcpv6_header {
    /** DHCPv6 message type */
    uint8_t messageType;
   ...
   */
  class DhcpV6Layer : public AbstractLayer {
  public:
     ...
     */
    DhcpV6Layer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet);
