...
namespace pcpp {
   ...
   */
  class PayloadLayer : public AbstractLayer {
  public:
    ...
    */
    PayloadLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : AbstractLayer(data, dataLen, prevLayer,
                                                                                                          packet) { m_Protocol = GenericPayload; }
