...
namespace pcpp {
  ...
  enum LinkLayerType {
    ...
    /** SLIP, encapsulated with a LINKTYPE_SLIP common */
    LINKTYPE_SLIP = 8,
    ...
    /** Reserved for private use */
    LINKTYPE_USER15 = 162,
    /** AVS monitor mode information followed by an 802.11 common */
    ...
    /** USB packets, beginning with a Linux USB common */
    LINKTYPE_USB_LINUX = 189,
    /** Per-Packet Information information */
    LINKTYPE_PPI = 192,
    /** IEEE 802.15.4 wireless Personal Area Network */
    LINKTYPE_IEEE802_15_4 = 195,
    /** Various link-layer types, with a pseudo-common, for SITA */
    LINKTYPE_SITA = 196,
    /** Various link-layer types, with a pseudo-common, for Endace DAG cards; encapsulates Endace ERF record */
    LINKTYPE_ERF = 197,
    /** Bluetooth HCI UART transport layer */
    LINKTYPE_BLUETOOTH_HCI_H4_WITH_PHDR = 201,
    /** AX.25 packet, with a 1-byte KISS common containing a type indicator */
    LINKTYPE_AX25_KISS = 202,
    /** Link Access Procedures on the D Channel (LAPD) frames */
    LINKTYPE_LAPD = 203,
    /** PPP, as per RFC 1661 and RFC 1662, preceded with a one-byte pseudo-common with a zero value meaning "received by this host" and a non-zero value meaning  "sent by this host" */
    ...
    /** Solaris ipnet pseudo-common */
    LINKTYPE_IPNET = 226,
    /** CAN (Controller Area Network) frames, with a pseudo-common as supplied by Linux SocketCAN */
    LINKTYPE_CAN_SOCKETCAN = 227,
    /** Raw IPv4; the packet begins with an sf_IPv4 common */
    LINKTYPE_IPV4 = 228,
    /** Raw IPv6; the packet begins with an IPv6 common */
    LINKTYPE_IPV6 = 229,
    ...
    /** D_PDUs as described by NATO standard STANAG 5066, starting with the synchronization sequence, and including both common and data CRCs */
    LINKTYPE_STANAG_5066_D_PDU = 237,
    /** Linux netlink NETLINK NFLOG socket log messages */
    LINKTYPE_NFLOG = 239,
    /** Pseudo-common for Hilscher Gesellschaft für Systemautomation mbH netANALYZER devices, followed by an Ethernet frame, beginning with the MAC common and ending with the FCS */
    LINKTYPE_NETANALYZER = 240,
    /** Pseudo-common for Hilscher Gesellschaft für Systemautomation mbH netANALYZER devices, followed by an Ethernet frame, beginning with the preamble, SFD, and MAC common, and ending with the FCS */
    LINKTYPE_NETANALYZER_TRANSPARENT = 241,
    /** IP-over-InfiniBand, as specified by RFC 4391 section 6 */
    LINKTYPE_IPOIB = 242,
    /** MPEG-2 Transport Stream transport packets, as specified by ISO 13818-1/ITU-T Recommendation H.222.0 */
    LINKTYPE_MPEG_2_TS = 243,
    /** Pseudo-common for ng4T GmbH's UMTS Iub/Iur-over-ATM and Iub/Iur-over-IP format as used by their ng40 protocol tester */
    LINKTYPE_NG40 = 244,
    /** Pseudo-common for NFC LLCP packet captures, followed by frame data for the LLCP Protocol as specified by NFCForum-TS-LLCP_1.1 */
    LINKTYPE_NFC_LLCP = 245,
    /** Raw InfiniBand frames, starting with the Local Routing Header */
    LINKTYPE_INFINIBAND = 247,
    /** SCTP packets, as defined by RFC 4960, with no lower-level protocols such as sf_IPv4 or IPv6 */
    LINKTYPE_SCTP = 248,
    /** USB packets, beginning with a USBPcap common */
    LINKTYPE_USBPCAP = 249,
    /** Serial-line packet common for the Schweitzer Engineering Laboratories "RTAC" product */
    LINKTYPE_RTAC_SERIAL = 250,
    /** Bluetooth Low Energy air interface Link AbstractLayer packets */
...
#define PCPP_MAX_PACKET_SIZE 65536
  ...
  public:
     ...
     */
    virtual bool
    setRawData(const uint8_t *pRawData, int rawDataLen, timeval timestamp, LinkLayerType layerType = LINKTYPE_ETHERNET,
               int frameLength = -1);
