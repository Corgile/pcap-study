...
namespace pcpp {
  ...
  public:
    ...
    /**
     * A constructor for this class that gets a pointer to the TLV record raw data (byte array)
    ...
    /**
     * A copy constructor for this class. This copy constructor doesn't copy the TLV data, but only the pointer to it,
  ...
  public:
    ...
    /**
     * A default copy constructor for this class
     */
   ...
   * A base class for building Type-Length-Value (TLV) records. This builder receives the record parameters in its constructor,
