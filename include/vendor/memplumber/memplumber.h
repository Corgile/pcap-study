...
public:
   ...
   */
  static void
  memLeakCheck(size_t &memLeakCount, uint64_t &memLeakSize, bool verbose = false, const char *fileDumperName = "",
               bool append = false) {
   ...
   * this parameter indicates whether to append the verbose information to the existing file or start writing from scratch
   */
  static void staticMemCheck(size_t &memCount, uint64_t &memSize, bool verbose = false, const char *fileDumperName = "",
                             bool append = false) {
