...
#include "osi/l7-application/DhcpLayer.h"
#include "osi/l7-application/DhcpV6Layer.h"
#include "osi/l2-datalink/VxlanLayer.h"
#include "osi/l5-session/SipLayer.h"
#include "osi/l7-application/RadiusLayer.h"
#include "osi/l4-transport/GtpLayer.h"
#include "osi/l7-application/NtpLayer.h"
#include "osi/l7-application/SomeIpLayer.h"
#include "osi/l2-datalink/WakeOnLanLayer.h"
...
namespace pcpp {
    ...
    if ((portSrc == 68 && portDst == 67) || (portSrc == 67 && portDst == 68) || (portSrc == 67 && portDst == 67))
      ...
      if (SipRequestFirstLine::parseMethod((char *) udpData, udpDataLen) != SipRequestLayer::SipMethodUnknown)
        m_NextLayer = new SipRequestLayer(udpData, udpDataLen, this, m_Packet);
          ...
          SipResponseFirstLine::parseStatusCode((char *) udpData, udpDataLen) != SipResponseLayer::SipStatusCodeUnknown
  ...
  std::string UdpLayer::toString() const {
    ...
    return "UDP AbstractLayer, Src port: " + srcPortStream.str() + ", Dst port: " + dstPortStream.str();
  }
