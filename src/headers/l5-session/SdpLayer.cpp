...
namespace pcpp {
  ...
  SdpLayer::SdpLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) : TextBasedProtocolMessage(data,
                                                                                                                         dataLen,
                                                                                                                         prevLayer,
                                                                                                                         packet) {
    m_Protocol = SDP;
  ...
  bool SdpLayer::addMediaDescription(const std::string &mediaType, uint16_t mediaPort, const std::string &mediaProtocol,
