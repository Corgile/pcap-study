...
#include "Logger.h"
#include "osi/l3-network/IPv6Extensions.h"
...
namespace pcpp {
  ...
  IPv6TLVOptionHeader::IPv6TLVOptionHeader(IDataContainer *dataContainer, size_t offset) : IPv6Extension(dataContainer,
                                                                                                         offset) {
  }
  ...
  IPv6RoutingHeader::IPv6RoutingHeader(uint8_t routingType, uint8_t segmentsLeft, const uint8_t *additionalRoutingData,
