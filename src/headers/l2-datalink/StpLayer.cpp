...
#include "osi/l2-datalink/StpLayer.h"
...
namespace pcpp {
  ...
  StpLayer *StpLayer::parseStpLayer(uint8_t *data, size_t dataLen, AbstractLayer *prevLayer, Packet *packet) {
    ...
    PCPP_LOG_DEBUG("Data length is less than any STP common");
    return nullptr;
  }
